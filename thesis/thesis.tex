...
\thesissetup{
    ...
    thanks        = {Many thanks to Jan Strejček for his all his advice, patience. I would also like to thank Juraj Major TODO:
    },
...
\begin{figure}[h] %TODO:
  ...
  \begin{tikzpicture}[->,>=stealth,shorten >=1pt,very thick,initial text={}]
      ...
      \path[->, very thick]
              (0) edge[]  node [above] {$a$} node[accset, collacc0, pos=0.30] {} node[accset, collacc1, pos=0.70] {} (1) 
              (1) edge[loop above]  node[above] {$\overline{b}$} node[accset, collacc0] {} (1)
              (1) edge[loop below]  node[below] {$b$} node[accset, collacc1] {} (1)
